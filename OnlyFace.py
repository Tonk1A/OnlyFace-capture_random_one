...
import random
import cv2
from PyQt5.QtWidgets import QLabel, QPushButton, QVBoxLayout, QWidget, QMessageBox, QDialog  # pylint: disable=E0611
...
saved_img = "images" # pylint: disable=C0103
if not os.path.exists(saved_img):
    os.mkdir(saved_img)

face_id = 0 # pylint: disable=C0103


def delete_all_files(directory): # pylint: disable=C0303
    '''
    hggvfhg
    '''
